...
texts = {'while': [['Введите условие:', 'Вместо "равно" используйте "==" (без кавычек).',
                    'Вместо "не равно" используйте "!=" (без кавычек).',
                    'После этого блока используйте блок "начало" и "конец", когда тело цикла закончится.']],
